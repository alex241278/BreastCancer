...
USAGE
-----
    from breastgnn.benchmarks import register_runtime_benchmarks
    ...
    from breastgnn.benchmarks import (
...
def _default_runtime_objects() -> Dict[str, Any]:
    """Objects that can be inferred from the installed BreastGNN package.
    ...
    try:
        ...
        from breastgnn.model import build_pruned_model_from
        from breastgnn.data import ExpressionDataset
        from breastgnn.training import (
            finetune_pruned, predict_proba_xh_mode, pretrain_masked_gene_model,
        )
        from breastgnn.losses import compute_metrics_full
    except Exception:
        return {}
