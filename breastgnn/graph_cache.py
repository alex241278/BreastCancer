...
import breastgnn.config as _cfg_module
from breastgnn.config import CFG as C
from breastgnn.graph import build_backbone, _validate_backbone_cache, load_expected_connected_genes
from breastgnn.data import build_regulator_features


# ── Defaults ────────────────────────────────────────────────────────────────
_DEFAULT_CACHE_DIR = Path(C.DATA_DIR) / "pipeline_cache"
